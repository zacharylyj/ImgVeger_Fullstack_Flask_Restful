...
def telegram_message(heading, user, repo, commit, commit_message, job_link):
    ...
    send_text = f'https://api.telegram.org/bot6892843292:AAFRxVctEMkxJMo8YqZu7tFpg2PscTJsQi4/sendMessage?chat_id=-1002005103869&parse_mode=Markdown&text={encoded_message}'
